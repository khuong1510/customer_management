...
INSERT INTO `clx_integrations` (`id`, `type`, `name`, `url`, `key`, `secret`, `is_active`, `is_default`, `created_at`, `updated_at`)
VALUES
	(4,'woocommerce','woocommerce local','https://wp.test','ck_9b08a41676e8aca0ad7f7df64d74ae18dad64289','cs_d3ce9458a3a5335c03f0bc9d2ef381a1fbaee7e7',1,0,'2018-07-23 05:11:56','2018-10-22 07:30:28'),
	(5,'woocommerce','eawal','https://awalvape.com','ck_c55f0b944883d2ce258197e1181221fcf51d0aa4','cs_c19393b428f072f63e7dc1d8c234e23fed072a78',1,1,'2018-10-22 07:30:25','2018-10-22 07:30:28');
...
--
-- Table structure for table `message_user_assoc`
--

CREATE TABLE IF NOT EXISTS `message_user_assoc` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
