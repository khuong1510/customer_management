...
<div id='main-container'>
    ...
    <div class="col-md-12">
        ...
        elseif (isset($_GET['_error']) && ($_GET['_error']) == '5') {
            echo '<hr><h4 style="color: red;"> Invalid Purchase Key, you will find your purchase key from here- <a href="https://app.cloudonex.com/orders" target="_blank">https://app.cloudonex.com/orders</a> </h4><hr>';
        }
        ...
        <form action="" method="post" id="ib_form">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="purchase_key" placeholder="raz0r" name="purchase_key" value="B5VE-SNP4-KB15-1179-7948">
                    <span class='help-block'>// <a target="_blank" href="https://bit.ly/2QCCRlD">FREE SCRIPT'S</a></span>
                </div>
