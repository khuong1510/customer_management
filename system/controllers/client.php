    ...
    case 'farmer-tree':
        ...
        switch ($req) {
            ...
            case 'all':
                ...
                $ds_mapping->SelectCommand = "select tree_id,account_id,area,age,amount from tree_mapping";
                $ds_mapping->DeleteCommand = "delete from tree_mapping where id=@id";

                $ds_customer = new MySQLiDataSource($db_con);
                $ds_customer->SelectCommand = "select DISTINCT crm_accounts.id,account,phone,street,ward,district,city from crm_accounts 
                                              LEFT JOIN tree_mapping ON crm_accounts.id = tree_mapping.account_id 
                                              WHERE cid = ".$c->id;
...
//                $grid->MasterTable->AutoGenerateColumns = true;
                ...
                // $table_detail->AutoGenerateColumns = true;//Auto Generate all column from tables
                $table_mapping->DisableAutoGenerateDataFields = "account_id";//Disable generate column for orderNumber data fields.
