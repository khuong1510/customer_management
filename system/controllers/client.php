...
switch ($action) {
    case 'farmer-tree':
        ...
        $ui->assign('_application_menu', 'farmer-tree');
        $ui->assign('_st', $_L['List Farmer Trees']);
        ...
        switch ($req) {
            case 'new':
                ...
                $deps = ORM::for_table('tree')->find_array();

                $ui->assign('deps',$deps);
                view('client_add_farmer_tree',[
            ...
            case 'all':
                ...
                if($c->type == 'Customer'){
                    ...
                    $ds_customer->SelectCommand = "select crm_accounts.id,account, area,phone,street,ward,district,city from crm_accounts where type LIKE '%Customer%' and id = ".$c->id;
...
//                    $grid->AutoGenerateDeleteColumn = false;
...
//                    $grid->MasterTable->InsertSettings->ColumnNumber = 2;
                    ...
                    $ds_customer->InsertCommand = "insert into crm_accounts (account,area,phone,street,ward,district,city,cid,password) values ('@account','@area','@phone','@street','@ward','@district','@city','".$c->id."','".$password_default."');";
...
//        $table_mapping->AutoGenerateExpandColumn = true;
            ...
            case 'create_post':
                ...
                $tickets = new FarmerTrees();

                $t = $tickets->create();


                if($t['success'] == 'Yes'){
                    _msglog('s','Data has been created successfully.');
                }
