...
<form class="form-horizontal" id="rform">
    ...
    <div class="form-group"><label class="col-lg-2 control-label" for="edit_secondary_email">{$_L['Secondary Email']}</label>
        <div class="col-lg-10"><input type="text" id="edit_secondary_email" name="secondary_email" class="form-control" value="{$d['secondary_email']}">
        </div>
    </div>
